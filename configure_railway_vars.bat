...
railway variables set DATABASE_PUBLIC_URL="postgresql://postgres:kfxXVvXBzOjBpszCQLlHDIruGdEpzEqP@tramway.proxy.rlwy.net:23336/railway"

echo 2. Configurando DATABASE_URL...
railway variables set DATABASE_URL="postgresql://postgres:kfxXVvXBzOjBpszCQLlHDIruGdEpzEqP@postgres.railway.internal:5432/railway"
