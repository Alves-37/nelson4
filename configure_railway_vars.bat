...
railway variables set DATABASE_PUBLIC_URL="postgresql://postgres:kEconJMLThoMByPxeyKJBIFvfFKyvZDP@shortline.proxy.rlwy.net:36604/railway"

echo 2. Configurando DATABASE_URL...
railway variables set DATABASE_URL="postgresql://postgres:kEconJMLThoMByPxeyKJBIFvfFKyvZDP@postgres.railway.internal:5432/railway"
